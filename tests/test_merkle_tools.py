...
from secmerkletools import secMerkleTools
...
def test_sha224():
    mt = secMerkleTools(hash_type='sha224')
    mt.add_leaf([
...
def test_sha256():
    mt = secMerkleTools(hash_type='sha256')
    mt.add_leaf([
...
def test_sha384():
    mt = secMerkleTools(hash_type='sha384')
    mt.add_leaf([
...
def test_sha512():
    mt = secMerkleTools(hash_type='sha512')
    mt.add_leaf([
...
def test_sha3_224():
    mt = secMerkleTools(hash_type='sha3_224')
    mt.add_leaf([
...
def test_sha3_256():
    mt = secMerkleTools(hash_type='sha3_256')
    mt.add_leaf([
...
def test_sha3_384():
    mt = secMerkleTools(hash_type='sha3_384')
    mt.add_leaf([
...
def test_sha3_512():
    mt = secMerkleTools(hash_type='sha3_512')
    mt.add_leaf([
